...
void Timirbaev_Warehouse::AddProduct(Ui::Timirbaev_Add_Dialog* ui) {
    shared_ptr<Timirbaev_Product> product = make_shared<Timirbaev_Product>();
    product->create_product(ui);
    products.push_back(product);
}

void Timirbaev_Warehouse::AddDefectProduct(Ui::Timirbaev_Add_Dialog* ui) {
    shared_ptr<Timirbaev_Defect_Product> defect_product = make_shared<Timirbaev_Defect_Product>();
    defect_product->create_product(ui);
